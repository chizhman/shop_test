...
def test_guest_can_add_product_to_basket(browser, number):
    ...
    pages.open()
    pages.test_guest_cant_see_success_message()
    pages.should_not_be_success_message()
    # pages.should_be_another_link()
    pages.should_be_add_butter()
    pages.add_to_basket()
    time.sleep(1)
    pages.test_guest_cant_see_success_message_after_adding_product_to_basket()
    pages.should_be_alert_adding_good()
    pages.should_be_alert_basket_price()
    pages.test_message_disappeared_after_adding_product_to_basket()